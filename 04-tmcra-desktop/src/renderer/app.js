...
const translations = {
  zh: {
    ...
    stepHooksCopy: "重启 Codex，逐项审阅并信任全部九项生命周期 Hook。",
    hookBoundaryTitle: "最后一步必须由你确认",
    hookBoundaryCopy: "Hook 授权由你亲自完成。重启 Codex、启用 TMCRA Memory，并检查全部九项权限请求后再确认下面的按钮。",
  ...
  en: {
    ...
    stepHooksCopy: "Restart Codex, then review and trust all nine lifecycle Hooks.",
    hookBoundaryTitle: "The final step stays under your control",
    hookBoundaryCopy: "Hook approval stays under your control. Restart Codex, enable TMCRA Memory and inspect all nine permission requests before confirming below.",
...
const phases = {
  zh: {
    ...
    connected_pending_hooks: ["TMCRA 已连接，还差 Codex 内确认", "连接和授权已经完成。现在请重启 Codex，并逐项确认全部九项 Hook。"],
  ...
  en: {
    ...
    connected_pending_hooks: ["Connected — one Codex confirmation remains", "Connection and authorization are complete. Restart Codex and confirm all nine Hooks."],
